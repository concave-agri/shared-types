...
export enum PotentialLeadCategory {
  ...
  INSECTICES = "Insecticides & Weedicides - " +
    QueriesSpecifications.CROP_SPECIFIC,
  FARM_MACHINERY = "Farm Machinery - " + QueriesSpecifications.FARMING_SPECIFIC,
  ALTERNATE_ENERGY = "Alternate Energy/Solar - " +
    QueriesSpecifications.FARMING_SPECIFIC,
  AGRI_INSURANCE = "Loan and Agri Insurance - " +
    QueriesSpecifications.FARMING_SPECIFIC,
  LIVESTOCK_SERVICE = "Livestock Product/Service - " +
    QueriesSpecifications.FARMING_SPECIFIC,
